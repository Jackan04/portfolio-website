...
const projects = [
  {
    ...
    description: `A two-part messaging application. The backend is a REST API built with Node.js, Express, PostgreSQL, and Prisma, handling authentication via JWT, user management, and conversations. 

The frontend is a React client that consumes the API, allowing users to search for others, start conversations, exchange messages, and manage their profile.`,
  },
  {
    category: categories[0],
    ...
    description: `A three-part blogging platform consisting of a REST API built with Node.js, Express, PostgreSQL, and JWT authentication, consumed by two separate frontends. 

Blog Admin handles authenticated content management, while Blog Public serves as the reader-facing client for browsing and commenting on published posts.`,
  },
  {
    category: categories[0],
